<div class="row p-2">
    ...
    <div class="col-md-6">
        ...
        <a href="/admin/transaksi/detail/selesai/{{ Request::segment(3) }}" class="btn btn-main-green-bg mr-2"><i class="fas fa-check mr-2"></i>Selesai</a>
        ...
        <div class="card">
            <div class="card-body">
                <form action="" method="GET">
                    ...
                    <button type="submit" class="btn btn-main-green-bg btn-block mb-2">Hitung</button>
                </form>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="kembalian" value="{{ format_rupiah($kembalian) }}" class="form-control" id="" disabled>
                    </div>
                </div>
            </div>
        </div>
