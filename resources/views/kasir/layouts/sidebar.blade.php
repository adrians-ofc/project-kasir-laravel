               ...
               with font-awesome or any other icon font library -->
                @if(auth()->user()->position === 'admin')
                    ...
                    <li class="nav-item mb-1">
                        <a href="/admin/dashboard" class="nav-link {{ Request::is('/admin/dashboard') ? 'active-green' : '' }}">
                ...
                @elseif(auth()->user()->position === 'kasir')
                    <li class="nav-item mb-1">
                        <a href="/kasir/dashboard" class="nav-link {{ Request::is('kasir/dashboard') ? 'active-green' : '' }}">
                            <i class="nav-icon fas fa-home"></i>
                            <p>
                                Dashboard
                            </p>
                    ...
                    <li class="nav-item mb-1">
                        <a href="/kasir/transaksi" class="nav-link {{ Request::is('kasir/transaksi*') ? 'active-green' : '' }}">
                            <i class="nav-icon fas fa-exchange-alt"></i>
                            <p>
                                Transaksi
                            </p>
                ...
                <li class="nav-item mb-1">
                    <a href="/kasir/setting" class="nav-link {{ Request::is('kasir/setting*') ? 'active-green' : '' }}">
